...
#include "ezinject_injcode_linux_inl.h"
#elif defined(EZ_TARGET_WINDOWS)
#include "ezinject_injcode_windows_inl.h"
#elif defined(EZ_TARGET_DARWIN)
#include "ezinject_injcode_darwin_inl.h"
#elif defined(EZ_TARGET_FREEBSD)
#include "ezinject_injcode_freebsd_inl.h"
#endif

struct injcode_call {
	uintptr_t magic; //EZSC1
	struct call_platform platform;
	uintptr_t ezstate;
	/** PLAPI **/
...
extern void injected_sc_trap_start(void);
extern void injected_sc_trap_stop(void);
...
extern void PLAPI trampoline(void);
extern void trampoline_entry(void);
extern void trampoline_exit(void);
